...
router.put('/:id/mark-all-completed',              controller.markAllCompleted);
router.put('/:id/finish-phase',                    controller.finishPhase);
router.put('/:id/mark-all-no-aplica-fase6',        controller.markAllNoAplicaFase6);
